...
import { DeepMap, FieldError, Control } from 'react-hook-form'
...
export const PersonFields = <T extends Person>({ register, errors, defaults, children, control }: PersonFieldsProps<T>): ReactElement => (
  <div>
    <LabeledInput
